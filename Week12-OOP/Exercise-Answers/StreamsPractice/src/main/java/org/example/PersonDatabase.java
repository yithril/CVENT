...
public class PersonDatabase {
    private static final List<Person> PERSONS = Arrays.asList(
            ...
            new Person(31, "Nina", "Williams", "Nurse", "Texas", 85000),
            new Person(32, "Olivia", "Brown", "Engineer", "California", 95000),
            new Person(33, "Liam", "Johnson", "Teacher", "Florida", 72000),
            new Person(34, "Emma", "Davis", "Doctor", "New York", 115000),
            new Person(35, "Noah", "Garcia", "Scientist", "Texas", 130000),
            new Person(36, "Ava", "Martinez", "Farmer", "California", 67000),
            new Person(37, "Sophia", "Miller", "Chef", "Georgia", 92000),
            new Person(38, "Mason", "Lee", "Architect", "Michigan", 99000),
            new Person(39, "Isabella", "Jones", "Teacher", "Florida", 71000),
            new Person(40, "Lucas", "Brown", "Engineer", "California", 140000)
            );
